...
import activeIconSvg from "./pin_active.svg"
...
const mapCenterPosition = {
    kiev: {lat: 50.4546600, lng: 30.5238000},
    odessa: {lat: 46.469391, lng: 30.740883},
    all: {lat: 48.9969392, lng: 31.4022422}
};
...
const MapWithAMakredInfoWindow = props => {
    ...
    const getCenter = () => {
        return mapCenterPosition[props.mapInitCity || 'all'];
    };

    const getZoom = () => {
        return mapZoom[props.mapInitCity || 'all']
    };
    ...
    return (
        <div className='wrap-map-on-home'>
            <GoogleMap
                defaultZoom={getZoom()}
                zoom={getZoom()}
                            ...
                            <div>
                                ...
                                <div className='wrap-info-window-on-home'>
                                    <div className="info-window">
                                        ...
                                        <Link to={`/${props.language}/${props.currentCategory}/${item.seo}`} className="info-window__desc">{item.description || item.title}</Link>
                                            ...
                                            : null}
                                        {
                                            item.photoPrewie ? <Link to={`/${props.language}/${props.currentCategory}/${item.seo}`} className="info-window__img"><img
                                                ...
                                                <div className="info-window__img"><img
