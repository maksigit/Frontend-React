...
import './tabs-with-arrows-infrastructure.scss';
import GMapInfrastructure from "../g-map-infrastructure/g-map-infrastructure";

class TabsWithArrowsInfrastructure extends Component {
    state = {
        tabIndex: 0,
        page: 6,
        data: [],
    ...
    componentDidUpdate() {
        if (this.state.data[1].tab_title !== this.props.item[0].tab_title) {
            this.addToTab()
        }
    }
    ...
    render() {
        ...
        const settings = {
            ...
            swipeToSlide: true,
            arrows: true,
            nextArrow: <div className='slick-btn-next'>
                <svg onClick={this.pageNext} width="45" height="11" viewBox="0 0 45 11" fill="none"
            ...
            prevArrow: <div className='slick-btn-next'>
                <svg onClick={this.pagePrev} width="45" height="11" viewBox="0 0 45 11" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd"
                ...
                <div className='tabs__bottom'>
                    {arrows === true ? <div className='tabs__bottom-flex'>
                        ...
                        <GMapInfrastructure
                            ...
                            // data={this.state.tabIndex === 0 ? this.allMarkets(data) : data[this.state.tabIndex]}
                            data={this.state.tabIndex === 0 ? data : data[this.state.tabIndex]}
                            point={this.props.mainPoint}
                            icon={this.state.tabIndex === 0 ? this.allMarkets(data) : data[this.state.tabIndex].tab_icon[0].path}
                        />
                    }
                </div>
            </div>
...
export default TabsWithArrowsInfrastructure;